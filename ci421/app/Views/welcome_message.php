...
<body>
  ...
  <header>
    ...
    <div class="heroe">
      ...
      <h1>Bien Venido to CodeIgniter <?= CodeIgniter\CodeIgniter::CI_VERSION ?></h1>
  ...
  <form method="post">
    ...
    <div></div>
    <input type="text" name="p2"> <input type="submit" value="send">
  </form>
  <!-- CONTENT -->
  ...
  <div class="further">
    ...
    <section>
      ...
      <p>The User Guide contains an introduction, tutorial, a number of "how to" guides, and then reference documentation for the components that make up the framework. Check the
        <a href="https://codeigniter4.github.io/userguide" target="_blank">User Guide</a> !
      </p>
      ...
      <p>CodeIgniter is a community-developed open source project, with several venues for the community members to gather and exchange ideas. View all the threads on
        <a href="https://forum.codeigniter.com/" target="_blank">CodeIgniter's forum</a>, or
        <a href="https://codeigniterchat.slack.com/" target="_blank">chat on Slack</a> !
      </p>
      ...
      <p>CodeIgniter is a community driven project and accepts contributions of code and documentation from the community. Why not
        <a href="https://codeigniter.com/contribute" target="_blank"> join us</a> ?
      </p>
